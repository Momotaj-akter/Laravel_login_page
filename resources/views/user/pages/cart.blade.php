@extends('user.app')
@section('title') user | cart Page @endsection
@section('content')
            ...
            <div class="row">
                ...
                <aside class="col-sm-3">
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside"><img src="{{ asset('user/images/icons/pay-visa.png') }}"></aside>
                        <div class="text-wrap small text-muted">
                            Pay 84.78 AED ( Save 14.97 AED ) By using ADCB Cards
                        </div>
                    </figure>
                    <figure class="itemside mb-3">
                        <aside class="aside"> <img src="{{asset('user/images/icons/pay-mastercard.png')}}"> </aside>
                        <div class="text-wrap small text-muted">
