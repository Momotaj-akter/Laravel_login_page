@extends('admin.app')
@section('title') Dashboard | form-custom @endsection
@section('content')
			...
			<div class="col-md-6">
				<div class="tile">
					<div class="tile-title-w-btn">
						...
						<p><a class="btn btn-primary icon-btn" href="https://select2.github.io/examples.html"
				...
				<div class="tile">
					<div class="tile-title-w-btn">
						...
						<p><a class="btn btn-primary icon-btn"
								href="http://bootstrap-datepicker.readthedocs.org/en/stable/options.html"
								target="_blank"><i class="fa fa-file"></i>Docs</a></p>
					</div>
					<div class="tile-body">
