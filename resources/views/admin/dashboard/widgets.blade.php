@extends('admin.app')
@section('title') Dashboard | widgets page @endsection
@section('content')
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="messanger">
              <div class="messages">
                <div class="message"><img src="../../s3.amazonaws.com/uifaces/faces/twitter/tonypeterson/48.jpg">
                  <p class="info">Hello there!<br>Good Morning</p>
                </div>
                <div class="message me"><img src="../../s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg">
